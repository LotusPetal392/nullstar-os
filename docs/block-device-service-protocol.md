...
`mkdir`, `rmdir`, rename, general service-definition management, and broader acceptance work remain
future; one policy-pinned definition-backed PID 1 activation pilot is implemented.
