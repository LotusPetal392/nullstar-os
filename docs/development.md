...
The block-device-loss runner copies its source image before boot. PID 1 offlines the exact writable
NullFS endpoint UUID and generation after a public mutation is prepared. The gate requires explicit
