...
pub const AHCI_SERVICE_ID: service_control::ServiceId =
    match service_control::ServiceId::from_bytes([
        0x1a, 0x2b, 0x3c, 0x4d, 0x5e, 0x6f, 0x40, 0x81, 0x92, 0xa3, 0xb4, 0xc5, 0xd6, 0xe7, 0xf8,
        0x09,
    ]) {
        Ok(id) => id,
...
pub const CONSOLE_SERVICE_ID: service_control::ServiceId =
    match service_control::ServiceId::from_bytes([
        0x2b, 0x3c, 0x4d, 0x5e, 0x6f, 0x70, 0x41, 0x92, 0xa3, 0xb4, 0xc5, 0xd6, 0xe7, 0xf8, 0x09,
        0x1a,
    ]) {
        Ok(id) => id,
...
pub const SERIAL_SERVICE_ID: service_control::ServiceId =
    match service_control::ServiceId::from_bytes([
        0x3c, 0x4d, 0x5e, 0x6f, 0x70, 0x81, 0x42, 0xa3, 0xb4, 0xc5, 0xd6, 0xe7, 0xf8, 0x09, 0x1a,
        0x2b,
    ]) {
        Ok(id) => id,
...
pub const KEYBOARD_SERVICE_ID: service_control::ServiceId =
    match service_control::ServiceId::from_bytes([
        0x4d, 0x5e, 0x6f, 0x70, 0x81, 0x92, 0x43, 0xb4, 0x85, 0xd6, 0xe7, 0xf8, 0x09, 0x1a, 0x2b,
        0x3c,
    ]) {
        Ok(id) => id,
...
pub const PCI_SERVICE_ID: service_control::ServiceId =
    match service_control::ServiceId::from_bytes([
        0x5e, 0x6f, 0x70, 0x81, 0x92, 0xa3, 0x44, 0xc5, 0x96, 0xe7, 0xf8, 0x09, 0x1a, 0x2b, 0x3c,
        0x4d,
    ]) {
        Ok(id) => id,
...
const KNOWN_SERVICES: [(&[u8], service_control::ServiceId); 9] = [
