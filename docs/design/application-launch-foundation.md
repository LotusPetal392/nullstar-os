...
1. **Portal mediation and grant-backed authority** — implement compositor and portal transports
   around the gesture admission, live resource resolver/restorer, rooted forwarding endpoints, and
   permission-store records, then bind active revocation into broker lifetime.
